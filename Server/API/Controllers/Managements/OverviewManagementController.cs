...
namespace API.Controllers.Managements
{
    ...
    [ApiController]
    [Authorize("Admin")]
    public class OverviewManagementController : ControllerBase
    {
        private readonly ISummaryService _summaryService;
        private readonly IHubContext<LogHub> _logHubContext;

        public OverviewManagementController(ISummaryService summaryService, IHubContext<LogHub> logHubContext)
        {
